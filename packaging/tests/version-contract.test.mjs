...
test("client-version.json exposes the production candidate with historical acceptance provenance", async () => {
  ...
  assert.deepEqual(version, {
    schemaVersion: 2,
    release: "1.0.3",
    releaseTag: "secure-client-v1.0.3",
    android: {
    ...
    linux: {packageIdentity: "iws-secure-client", packageVersion: "1.0.3", acceptedCommit: "2ef63e2e34bff31b0ad9a7d12ccf6c97c33c4e51", platforms: ["LINUX_DEBIAN", "LINUX_FEDORA"], rebootVerification: "USER_DEFERRED"},
    transport: {
